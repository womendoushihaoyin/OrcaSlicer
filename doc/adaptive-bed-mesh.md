...
Snapmaker Orca introduces comprehensive support for adaptive bed meshing across a variety of firmware, including Marlin, Klipper, and RepRapFirmware (RRF).   
...
## Example of Adaptive Bed Mesh usage in Snapmaker Orca:  
