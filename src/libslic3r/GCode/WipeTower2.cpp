...
// From BambuStudio: Map for minimum depth per height (used by get_limit_depth_by_height)
...
// Returns the minimum required depth for the wipe tower based on its height
// Uses interpolation between predefined height-depth pairs
...
// Returns brim width scaling factor based on height (up to 8mm)
